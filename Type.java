...
public enum Type {
    ...
    BEEHIVE("Beehive",Category.FARMING),
    ...
    TOWN_HALL("Town Hall",Category.INFRASTRUCTURE),
    TAX_OFFICE("Tax Office",Category.INFRASTRUCTURE),
    CONSTABULARY("Constabulary",Category.INFRASTRUCTURE),
    LIBRARY("Library",Category.INFRASTRUCTURE),
    TEMPLE("Temple",Category.INFRASTRUCTURE),
    MINSTREL_GUILD("Minstrel Guild",Category.INFRASTRUCTURE);
